...
@IonicPage()
@Component({
  selector: 'page-profile-transaction',
  templateUrl: 'profile-transaction.html',
})
export class ProfileTransactionPage {
  ...
  public transactionListLength: any;
  public keys: any;
  ...
  getTransactionList() {
    ...
    let post_data = { 'api_url': 'getCoinsTransactionList', "post": { "member_id": this.id, "currentDate": "" } };
    this.crudHttpProvider.callToCrudPost(post_data)
      .then(data => {
